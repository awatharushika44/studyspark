  ...
  async (req, res) => {
    try {
      ...
      if (ai) {
        try {
          console.log(
            '🤖 Generating AI study plan with Gemini...'
          )
          ...
          console.log(
            '🎉 Gemini AI planner succeeded!'
          )

        } catch (aiErr) {
          console.error(
            '❌ AI planner failed, falling back to rule-based:',
            aiErr.message
          )
